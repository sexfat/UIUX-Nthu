...
> 📋 **[課程總覽頁](https://sexfat.github.io/2026UIUX-Class/)**（[原始碼 index.html](index.html)）— 依清華大學課程時程整理 12 單元與簡報連結
>
> **目前課程名稱、日期、時段與教材狀態一律以 `index.html` 為準；完整課程大綱見 `清華大學課程大綱.md`。**
> 舊版（資展國際班、Figma 導向舊大綱）僅供歷史備查，已整合於 `舊版課綱備查.md`。

### 2026上課時間

日期：9/16、9/23、9/30、10/7、10/14、10/21、10/28、11/4、11/18、11/25、12/2、12/9，共12次
時間：每周三 13:20-16:20
地點：清華大學第二綜合大樓2樓電腦教室II
...
| 單元 | 主題 | 連結 |
|------|------|------|
| Unit 01 | 瞭解用戶體驗與設計思考，與規劃流程介紹 | [簡報](https://sexfat.github.io/2026UIUX-Class/Unit_01/slides.html) |
| Unit 02 | AI 輔助訪談與分析（合併訪談／競品分析／旅程地圖） | [簡報](https://sexfat.github.io/2026UIUX-Class/Unit_02/slides.html) / [完整教材](https://sexfat.github.io/2026UIUX-Class/Unit_02/article.html) / [AI 提示詞](https://sexfat.github.io/2026UIUX-Class/Unit_02/interview-prompt.html) |
| Unit 03 | Figma 基本操作 | [簡報](https://sexfat.github.io/2026UIUX-Class/Unit_03/slides.html) / [講義](https://sexfat.github.io/2026UIUX-Class/Unit_03/article.html) / [練習與作業](https://sexfat.github.io/2026UIUX-Class/Unit_03/exercises.html) |
...
- 新增 `Unit_03/slides.html`（20 張）、`Unit_03/article.html`（11 節）、`Unit_03/exercises.html`（4 階段課堂練習＋回家作業），內容依據 Figma 官方 Help Center 文件整理，來源整理見 `Unit_03/resources/`。
- 新增 `Unit_03/resources/figma-demo/`：4 張示範截圖（形狀與圖層、Auto Layout 前後對照、Component 與 Variants、Prototype 連接），取自實際建立的示範用 Figma 檔案。
- 更新 `index.html`：Unit 03 卡片新增「簡報」「講義」「練習與作業」連結。
- 更新 `Unit_03/README.md`：補齊課程目標、課程內容、時間分配、練習、作業與參考資料。
